<aside class="sidebar sidebar-default navs-rounded-all {{ Route::currentRouteName() == 'orders.create' ? 'sidebar-mini' : '' }}">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="{{ route('dashboard') }}" class="navbar-brand">
            ...
            <!--logo End-->
            <h5 class="logo-title">كافية الركنة</h5>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(Route::is('rooms.index') ) active @endif" href="{{ route('rooms.index') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <span class="item-name">الرومات</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if(Route::is('tables.index') ) active @endif" href="{{ route('tables.index') }}">
                        ...
                        <span class="item-name">الطاولات</span>
                    </a>
                </li>
                <li class="nav-item">
